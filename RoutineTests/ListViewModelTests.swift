...
//        let routine = Routine(title: "title", dayOfWeek: DayOfWeek.allCases, startDate: Date())
...
//        let todo = Todo(title: "Test", taskDate: Date())
...
//        let routine = Routine(title: "title", dayOfWeeks: DayOfWeek.allCases, startDate: Date())
//        sut.create(routine: routine)
...
//        routines.append(Routine(title: "title", dayOfWeeks: DayOfWeek.allCases, startDate: Date()))
//        routines.append(Routine(title: "title", dayOfWeeks: [.mon, .wed, .fir], startDate: Date()))
//        routines.append(Routine(title: "title", dayOfWeeks: [.tue, .thu], startDate: Date()))
//        
//        routines.forEach { routine in
//            sut.create(routine: routine)
//        }
//        taskCount += routines.compactMap { routine in
//            routine.dayOfWeeks.first(where: { $0 == weekDay })
//        }.count
//        
//        let todo = Todo(title: "TestTodo", taskDate: Date())
//        sut.append(todo: todo)
//        
//        taskCount += 1
//        
